...
BOOST_AUTO_TEST_CASE( test_euler_1d )
{
  ...
  Handle<dcm::Model> model = Core::instance().root().create_component<dcm::Model>("model1d");
  ...
  Handle<solver::BC> bc_mirror = euler->add_bc("mirror","cf3.dcm.equations.euler.BCMirror1D",bc_regions);
...
BOOST_AUTO_TEST_CASE( test_euler_2d )
{
  ...
  Handle<solver::BC> bc_mirror = euler->add_bc("mirror","cf3.dcm.equations.euler.BCMirror2D",bc_regions);
...
//  Handle<solver::PDESolver> solver = model->add_solver( "ERK_5_3", euler,
//                                                        "cf3.dcm.solver.optim_erkls.ERK_5_3",
//                                                        "cf3.solver.ImposeCFL" );
//  Handle<solver::PDESolver> solver = model->add_solver( "RK_solver", euler,
//                                                        "cf3.dcm.solver.erkls.TwoSstar",
//                                                        "cf3.solver.ImposeCFL" );
 Handle<solver::PDESolver> solver = model->add_solver( "MidPoint", euler,
