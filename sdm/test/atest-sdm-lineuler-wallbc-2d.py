...
### Add BC
lineuler.add_bc( name='farfield', type='cf3.dcm.equations.lineuler.BCFarfield2D',
                 regions=[ mesh.topology.left, mesh.topology.top ] )
lineuler.add_bc( name='mirror', type='cf3.dcm.equations.lineuler.BCMirror2D',
                 regions=[ mesh.topology.bottom ] )
lineuler.add_bc( name='outlet', type='cf3.dcm.equations.lineuler.BCExtrapolation2D',
