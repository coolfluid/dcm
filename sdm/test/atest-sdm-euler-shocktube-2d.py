...
### Create new model
model = cf.root.create_component('shocktube_2d','cf3.dcm.Model');
...
mesh_generator.lengths = [10,10]
mesh_generator.offsets = [-5,-5]
...
### Solve
solver = model.add_solver(pde=euler,solver='cf3.dcm.solver.erk.MidPoint')
