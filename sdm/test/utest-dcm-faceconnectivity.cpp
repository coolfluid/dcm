...
#include "cf3/dcm/core/Tensorial.hpp"
#include "cf3/dcm/core/LegendreGaussEnd.hpp"
...
struct dcm_MPITests_Fixture
{
  /// common setup for each test case
  dcm_MPITests_Fixture()
  {
...
BOOST_FIXTURE_TEST_SUITE( dcm_solver_TestSuite, dcm_MPITests_Fixture )
