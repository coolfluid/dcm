...
#ifndef cf3_sdm_equations_lineuler_BCWallNonUniformMeanflow2D_hpp
#define cf3_sdm_equations_lineuler_BCWallNonUniformMeanflow2D_hpp
...
class sdm_equations_lineuler_API BCWallNonUniformMeanflow2D : public BCWeak< BCNonUniformPhysData2D >
{
public:
...
private:
  ...
  virtual void compute_flx_pt_phys_data(const SFDElement& elem, const Uint flx_pt, PhysData& phys_data )
  {
    ...
    //DEBUG  elem.reconstruct_from_solution_space_to_flux_points[flx_pt](sol_pt_meanflow,meanflow);
...
#endif // cf3_sdm_equations_lineuler_BCWallNonUniformMeanflow2D_hpp
