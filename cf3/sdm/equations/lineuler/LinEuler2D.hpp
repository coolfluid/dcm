...
#ifndef cf3_sdm_equations_lineuler_LinEuler2D_hpp
#define cf3_sdm_equations_lineuler_LinEuler2D_hpp
...
class sdm_equations_lineuler_API LinEuler2D : public sdm::Physics {
...
public: // functions
  ...
  virtual void create_terms( const Handle<sdm::DomainDiscretization>& domain_discretization );
...
private: // data
  ...
  Handle<sdm::Term>                         m_convection;
  Handle<sdm::Term>                         m_mean_flow_source;
...
#endif // cf3_sdm_equations_lineuler_LinEuler2D_hpp
