...
/// @file plugins/cf3/dcm/solver/erk/Types.hpp
...
#include "cf3/dcm/solver/erk/RungeKutta.hpp"
...
// Their type-name = "cf3.dcm.explicit_rungekutta.<butcher_tableau>", with
// <butcher_tableau> the name of the Butcher Tableau

/// @brief forward Euler time integration method
typedef RungeKuttaT<butcher_tableau::ForwardEuler> ForwardEuler;

/// @brief 2-stage 2nd-order Heun time integration method
typedef RungeKuttaT<butcher_tableau::Heun2>        Heun2;

/// @brief MidPoint time integration method
typedef RungeKuttaT<butcher_tableau::MidPoint>     MidPoint;

/// @brief Classic RK33 time integration method
typedef RungeKuttaT<butcher_tableau::ClassicRK33>  ClassicRK33;

/// @brief 3-stage 3rd-order Heun time integration method
typedef RungeKuttaT<butcher_tableau::Heun3>        Heun3;
...
typedef RungeKuttaT<butcher_tableau::RK65>         RK65;

/// @brief 6-stage 5th-order RKF time integration method
typedef RungeKuttaT<butcher_tableau::RKF65>        RKF65;
