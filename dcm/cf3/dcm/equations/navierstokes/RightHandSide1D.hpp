...
#ifndef cf3_dcm_equations_navierstokes_RightHandSide1D_hpp
#define cf3_dcm_equations_navierstokes_RightHandSide1D_hpp
...
class dcm_equations_navierstokes_API RightHandSide1D : public solver::TermBase< 1 /*dim*/, 3 /*eqs*/, 3 /*vars*/, 2/*grads*/ >
{
public: 

  /// @brief Constructor
  RightHandSide1D( const std::string& name );
  
  /// @brief Destructor
  virtual ~RightHandSide1D() {}
  
  static std::string type_name() { return "NSRightHandSide1D"; }
...
private: // configuration
  ...
  Handle< solver::RiemannSolver<cf3::physics::euler::euler1d::Data,NDIM,NEQS> > m_riemann_solver;
...
#endif // cf3_dcm_equations_navierstokes_RightHandSide1D_hpp
