...
#include "cf3/dcm/BoundaryConditions.hpp"
#include "cf3/dcm/Physics.hpp"
#include "cf3/dcm/DomainDiscretization.hpp"
#include "cf3/dcm/Term.hpp"
...
common::ComponentBuilder < LinEuler2D, dcm::Physics, LibLinEuler > LinEuler2D_Builder;
...
void LinEuler2D::create_terms( const Handle<dcm::DomainDiscretization>& domain_discretization)
{
  m_convection = domain_discretization->create_term("convection","cf3.dcm.lineuler.ConvectionNonUniformMeanflow2D").handle<Term>();
  configure_terms();
}
