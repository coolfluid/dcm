...
#ifndef cf3_dcm_navierstokesmovingreference_BCSubsonicInlet2D_hpp
#define cf3_dcm_navierstokesmovingreference_BCSubsonicInlet2D_hpp
...
class dcm_navierstokes_API BCSubsonicInletTtPtAlpha2D : public BCWeak< PhysDataBase<4u,2u> >
{
private:
...
class dcm_navierstokes_API BCSubsonicInletUT2D : public BCWeak< PhysDataBase<4u,2u> >
{
private:
  enum {Rho=0, RhoUx=1, RhoUy=2, RhoE=3};
