...
#ifndef cf3_dcm_navierstokes_LibNavierStokes_hpp
#define cf3_dcm_navierstokes_LibNavierStokes_hpp
...
#ifdef COOLFLUID_dcm_NAVIERSTOKES_EXPORTS
#   define dcm_navierstokes_API      CF3_EXPORT_API
#   define dcm_navierstokes_TEMPLATE
#else
#   define dcm_navierstokes_API      CF3_IMPORT_API
#   define dcm_navierstokes_TEMPLATE CF3_TEMPLATE_EXTERN
#endif
...
class dcm_navierstokes_API LibNavierStokesMovingReference : public common::Library
{
public:
...
public: // functions
  ...
  static std::string library_namespace() { return "cf3.dcm.navierstokesmovingreference"; }
...
#endif // cf3_dcm_navierstokes_LibNavierStokesMovingReference_hpp
