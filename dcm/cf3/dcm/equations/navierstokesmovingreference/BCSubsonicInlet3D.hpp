...
#ifndef cf3_dcm_navierstokesmovingreference_BCSubsonicInlet3D_hpp
#define cf3_dcm_navierstokesmovingreference_BCSubsonicInlet3D_hpp
...
#include "dcm/BCWeak.hpp"
#include "dcm/navierstokesmovingreference/LibNavierStokesMovingReference.hpp"
...
class dcm_navierstokes_API BCSubsonicInletTtPtAlpha3D : public BCWeak< PhysDataBase<5u,3u> >
{
private:
...
class dcm_navierstokes_API BCSubsonicInletUT3D : public BCWeak< PhysDataBase<5u,3u> >
{
private:
  enum {Rho=0, RhoUx=1, RhoUy=2, RhoUz=3, RhoE=4};
...
#endif // cf3_dcm_BCSubsonicInlet3D_hpp
