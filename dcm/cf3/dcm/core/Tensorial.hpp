...
class dcm_core_API Point : public dcm::core::ShapeFunction
{
public: // typedefs
...
template< typename DISTRIBUTION_1D, int P >
class dcm_core_API Line : public dcm::core::ShapeFunction
{
public: // typedefs
...
template< typename DISTRIBUTION_1D, int P >
class dcm_core_API Quad : public dcm::core::ShapeFunction
{
public: // typedefs
...
template< typename DISTRIBUTION_1D, int P >
class dcm_core_API Hexa : public dcm::core::ShapeFunction
{
public: // typedefs
...
#endif // cf3_dcm_core_ShapeFunctionT_hpp
